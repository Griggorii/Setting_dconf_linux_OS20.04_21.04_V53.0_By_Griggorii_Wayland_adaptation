...
release-check-time=uint32 1649430827
...
[org/gnome/Totem]
active-plugins=['pythonconsole', 'open-directory', 'screensaver', 'rotation', 'autoload-subtitles', 'skipto', 'variable-rate', 'screenshot', 'apple-trailers', 'save-file', 'movie-properties', 'recent', 'vimeo', 'mpris', 'totem-im-status', 'opensubtitles']
...
[org/gnome/deja-dup]
backend='google'
prompt-check='2022-05-01T10:14:17.818134Z'
...
picture-uri='file:///home/griggorii/%D0%98%D0%B7%D0%BE%D0%B1%D1%80%D0%B0%D0%B6%D0%B5%D0%BD%D0%B8%D1%8F/hardy_wallpaper_uhd.png'
...
start-note='note://gnote/67462fea-9080-472b-a802-cc19c32d0a59'
